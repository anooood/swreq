...
real_T interp2_NJA6JVlk(const real_T varargin_1[8], const real_T varargin_2[6],
  const real_T varargin_3[48], real_T varargin_4, real_T varargin_5)
{
  real_T Vq;
  int32_T low_i;
  int32_T low_ip1;
