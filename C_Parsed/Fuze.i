# 0 "P3_MCP_Application/cmake-src/src/Fuze.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "P3_MCP_Application/cmake-src/src/Fuze.c"
# 23 "P3_MCP_Application/cmake-src/src/Fuze.c"
...
void StopTimer(void);
# 28 "P3_MCP_Application/cmake-src/src/Fuze.c" 2
...
# 29 "P3_MCP_Application/cmake-src/src/Fuze.c" 2
...
# 30 "P3_MCP_Application/cmake-src/src/Fuze.c" 2
...
# 31 "P3_MCP_Application/cmake-src/src/Fuze.c" 2
...
# 32 "P3_MCP_Application/cmake-src/src/Fuze.c" 2
...
# 33 "P3_MCP_Application/cmake-src/src/Fuze.c" 2
...
# 34 "P3_MCP_Application/cmake-src/src/Fuze.c" 2
...
# 35 "P3_MCP_Application/cmake-src/src/Fuze.c" 2
...
# 36 "P3_MCP_Application/cmake-src/src/Fuze.c" 2
# 1 "P3_MCP_Application/cmake-src/src/ETE.h" 1
# 14 "P3_MCP_Application/cmake-src/src/ETE.h"
...
# 37 "P3_MCP_Application/cmake-src/src/Fuze.c" 2
...
uint8_t FuzeFMU152_CheckDelay(uint8_t checkDelay) {
 ...
 if (checkDelay < ((uint8_t)(3))) {
  FilteredDelay = 0;
 }
 else if (checkDelay < ((uint8_t)(10))) {
  FilteredDelay = ((uint8_t)(5));
 }
 else if (checkDelay < ((uint8_t)(20))) {
  FilteredDelay = ((uint8_t)(15));
 }
 else if (checkDelay < ((uint8_t)(30))) {
  FilteredDelay = ((uint8_t)(25));
 }
 else if (checkDelay < ((uint8_t)(40))) {
  FilteredDelay = ((uint8_t)(35));
 }
 else if (checkDelay < ((uint8_t)(50))) {
  FilteredDelay = ((uint8_t)(45));
 }
 else if (checkDelay < ((uint8_t)(75))) {
  FilteredDelay = ((uint8_t)(60));
 }
 else if (checkDelay < ((uint8_t)(135))) {
  FilteredDelay = ((uint8_t)(90));
 }
 else if (checkDelay < ((uint8_t)(210))) {
  FilteredDelay = ((uint8_t)(180));
 }
 else {
  FilteredDelay = ((uint8_t)(240));
 }
...
uint8_t Fuze_SetDelay(uint8_t newFuzeDelay, uint8_t FromNodeId)
{
  ...
  if ((SS_FUZE.Fuze.Status.Bits.InitComplete== 1U) && (SS_FUZE.Fuze.Status.Bits.CommsOk == 1U)) {
    if ((SS_FUZE.Fuze.Type != (uint8_t)fuzeMECHANICAL) && (SS_FUZE.Fuze.Mode != (uint8_t)fmNON_PROGRAMMABLE) && (SS_FUZE.Fuze.Mode != (uint8_t)fmHEIGHT) && (SS_FUZE.Fuze.FuzeTimeDelay != newFuzeDelay)) {
     SS_FUZE.Fuze.Updating = 1U;
     SS_FUZE.Fuze.UpdateSuccessful = 0U;
      ...
      IF_SendMsg((uint8_t)(0x20), (uint8_t *) &SS_FUZE.FuzeSettings, sizeof(SS_FUZE.FuzeSettings));
...
void FuzeHandleRxData(uint8_t *RxData)
{
  ...
  switch (header->MsgId) {
    case (uint8_t)(0x90) : Fuze_HandleStatusMsg((sFuzeStatusMsg *) RxData); break;
    case (uint8_t)(0x08) : {

     SS_FUZE.Fuze.UpdateSuccessful = 1U;
     SS_FUZE.Fuze.ACK_RxCnt++;
     if (AUXCTRL_SS.FuzeControls.RxAuxOn != 0U) {
      AUXsprintf("%u:FUZE Settings update ACK %d (Successful)\n",GetTimeUs(),SS_FUZE.Fuze.ACK_RxCnt);
     }

     if (SS_FUZE.CommsControls.FuzeResultDestNodeId == 250) {
      TestEquipmentSendAcknowledgeMessage(250, 1);
     }
    } break;
    case (uint8_t)(0x09) : {
     ...
     if (SS_FUZE.CommsControls.FuzeResultDestNodeId == 250) {
      TestEquipmentSendAcknowledgeMessage(250, 0);
     }
    } break;
    default : break;
  }
...
void Fuze_Service(void)
{
 if (AUXCTRL_SS.MAINControls.FuzeCardFittedOn == 1U) {
  ...
  if (SS_FUZE.ServiceControls.TimeDiff > ((uint32_t)(200000))) {
