# 0 "P3_MCP_Application/cmake-src/src/IMU.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "P3_MCP_Application/cmake-src/src/IMU.c"
# 20 "P3_MCP_Application/cmake-src/src/IMU.c"
...
# 2 "/home/anood/anaconda3/lib/python3.12/site-packages/pycparser/utils/fake_libc_include/string.h" 2
...
# 3 "/home/anood/anaconda3/lib/python3.12/site-packages/pycparser/utils/fake_libc_include/string.h" 2
# 21 "P3_MCP_Application/cmake-src/src/IMU.c" 2
# 1 "/home/anood/anaconda3/lib/python3.12/site-packages/pycparser/utils/fake_libc_include/stdio.h" 1
# 22 "P3_MCP_Application/cmake-src/src/IMU.c" 2
...
void StopTimer(void);
# 23 "P3_MCP_Application/cmake-src/src/IMU.c" 2
...
# 24 "P3_MCP_Application/cmake-src/src/IMU.c" 2
...
# 25 "P3_MCP_Application/cmake-src/src/IMU.c" 2
...
# 26 "P3_MCP_Application/cmake-src/src/IMU.c" 2
...
# 27 "P3_MCP_Application/cmake-src/src/IMU.c" 2
# 1 "P3_MCP_Application/cmake-src/src/IMU.h" 1
# 16 "P3_MCP_Application/cmake-src/src/IMU.h"
#pragma pack(1)
...
# 28 "P3_MCP_Application/cmake-src/src/IMU.c" 2
# 1 "P3_MCP_Application/cmake-src/src/TypeDefines.h" 1
# 29 "P3_MCP_Application/cmake-src/src/IMU.c" 2
# 1 "P3_MCP_Application/cmake-src/src/FPGA.h" 1
# 30 "P3_MCP_Application/cmake-src/src/IMU.c" 2
# 1 "P3_MCP_Application/cmake-src/src/Interrupts.h" 1
# 15 "P3_MCP_Application/cmake-src/src/Interrupts.h"
typedef enum
{
  ipHIGHEST,
  ipHIGH,
...
# 31 "P3_MCP_Application/cmake-src/src/IMU.c" 2
# 1 "P3_MCP_Application/cmake-src/src/SDLC.h" 1
# 15 "P3_MCP_Application/cmake-src/src/SDLC.h"
typedef enum
{
  sdlcOK,
  sdlcCRC_ERR,
...
# 32 "P3_MCP_Application/cmake-src/src/IMU.c" 2
# 1 "P3_MCP_Application/cmake-src/src/TaskManager.h" 1
# 16 "P3_MCP_Application/cmake-src/src/TaskManager.h"
typedef enum
{
  task600HZ,
  task100HZ,
...
# 33 "P3_MCP_Application/cmake-src/src/IMU.c" 2
# 1 "P3_MCP_Application/cmake-src/src/WeaponSettings.h" 1
# 14 "P3_MCP_Application/cmake-src/src/WeaponSettings.h"
...
# 15 "P3_MCP_Application/cmake-src/src/WeaponSettings.h" 2
...
# 34 "P3_MCP_Application/cmake-src/src/IMU.c" 2
# 67 "P3_MCP_Application/cmake-src/src/IMU.c"
#pragma pack(1)
...
void IMU_Init(char *AuxStr)
{
  ...
  SDLC_Init((sSDLC *) &IMU_SDLC, 0x41800000, IMU_InterruptHandler);
}
...
void IMU_InterruptHandler(unsigned char *RxData, unsigned short Length, eSDLC_Result Status)
{
  ...
  if (Status != sdlcCRC_ERR) {
    if (header->Address == 0x0A) {
      if ((header->Id == 0x01) && (Length == sizeof(sIMU_Message1))) {
        ...
        memcpy((void *) &IMU.RawData, &msg1->Data, sizeof(sIMU_Message1Data));

        IMU.InertialData.AngularRate[0] = -msg1->Data.AngularRateX * 0.00457763671875;
        IMU.InertialData.AngularRate[1] = msg1->Data.AngularRateZ * 0.0011444091796875;
        IMU.InertialData.AngularRate[2] = msg1->Data.AngularRateY * 0.0011444091796875;
        IMU.InertialData.Acceleration[0] = -msg1->Data.AccelerationX * 0.02232421875;
        IMU.InertialData.Acceleration[1] = msg1->Data.AccelerationZ * 0.02232421875;
        IMU.InertialData.Acceleration[2] = msg1->Data.AccelerationY * 0.02232421875;
      ...
      else if ((header->Id == 0x02) && (Length == sizeof(sIMU_Message2))) {
        if (Status == sdlcSEQ_ERR) {
        ...
        IMU.InertialData.AngularRate[0] = (double) -msg2->Data.AngularRateX * 0.00457763671875;
        IMU.InertialData.AngularRate[1] = (double) msg2->Data.AngularRateZ * 0.0011444091796875;
        IMU.InertialData.AngularRate[2] = (double) msg2->Data.AngularRateY * 0.0011444091796875;
        IMU.InertialData.Acceleration[0] = (double) -msg2->Data.AccelerationX * 0.02232421875;
        IMU.InertialData.Acceleration[1] = (double) msg2->Data.AccelerationZ * 0.02232421875;
        IMU.InertialData.Acceleration[2] = (double) msg2->Data.AccelerationY * 0.02232421875;
        IMU.InertialData.DeltaAngle[0] = (double) -msg2->Data.DeltaAngleX * (1.0 / 1073741824);
        IMU.InertialData.DeltaAngle[1] = (double) msg2->Data.DeltaAngleZ * (1.0 / 4294967296);
        IMU.InertialData.DeltaAngle[2] = (double) msg2->Data.DeltaAngleY * (1.0 / 4294967296);
        IMU.InertialData.DeltaVelocity[0] = (double) -msg2->Data.DeltaVelocityX * (0.3048 / 67108864);
        IMU.InertialData.DeltaVelocity[1] = (double) msg2->Data.DeltaVelocityZ * (0.3048 / 67108864);
        IMU.InertialData.DeltaVelocity[2] = (double) msg2->Data.DeltaVelocityY * (0.3048 / 67108864);
