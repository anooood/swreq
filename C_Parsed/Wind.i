# 0 "P3_MCP_Application/cmake-src/src/Wind.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "P3_MCP_Application/cmake-src/src/Wind.c"
# 17 "P3_MCP_Application/cmake-src/src/Wind.c"
...
# 18 "P3_MCP_Application/cmake-src/src/Wind.c" 2
# 1 "P3_MCP_Application/cmake-src/src/TypeDefines.h" 1
# 19 "P3_MCP_Application/cmake-src/src/Wind.c" 2
# 1 "P3_MCP_Application/cmake-src/src/CRC.h" 1
# 15 "P3_MCP_Application/cmake-src/src/CRC.h"
void InitCRC(void);
...
# 20 "P3_MCP_Application/cmake-src/src/Wind.c" 2
# 1 "P3_MCP_Application/cmake-src/src/Weapon.h" 1
# 15 "P3_MCP_Application/cmake-src/src/Weapon.h"
...
void StopTimer(void);
# 16 "P3_MCP_Application/cmake-src/src/Weapon.h" 2
...
# 15 "P3_MCP_Application/cmake-src/src/MCP.h"
...
# 16 "P3_MCP_Application/cmake-src/src/MCP.h" 2
...
# 17 "P3_MCP_Application/cmake-src/src/MCP.h" 2
...
# 21 "P3_MCP_Application/cmake-src/src/Wind.c" 2
...
# 23 "P3_MCP_Application/cmake-src/src/Wind.c" 2
...
uint8_t WindSet(sWind *WindData)
{
  ...
  crc = CalculateMIL_STD_1760D_Crc((uint16_t *) WindData, (sizeof(sWind) - (uint16_t)(6)) / (uint16_t)(2));

  if (crc == WindData->CRC) {
    Weapon.Flags.Bits.WindOk = 1U;
    Weapon.Wind = *WindData;
  }
  else {
    Weapon.Flags.Bits.WindOk = 0U;
  }
