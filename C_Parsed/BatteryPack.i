# 0 "P3_MCP_Application/cmake-src/src/BatteryPack.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "P3_MCP_Application/cmake-src/src/BatteryPack.c"
# 25 "P3_MCP_Application/cmake-src/src/BatteryPack.c"
...
void StopTimer(void);
# 34 "P3_MCP_Application/cmake-src/src/BatteryPack.c" 2
...
# 35 "P3_MCP_Application/cmake-src/src/BatteryPack.c" 2
...
# 37 "P3_MCP_Application/cmake-src/src/BatteryPack.c" 2
...
# 40 "P3_MCP_Application/cmake-src/src/BatteryPack.c" 2
...
# 41 "P3_MCP_Application/cmake-src/src/BatteryPack.c" 2
...
# 15 "P3_MCP_Application/cmake-src/src/Mission.h"
...
# 42 "P3_MCP_Application/cmake-src/src/BatteryPack.c" 2
# 1 "P3_MCP_Application/cmake-src/src/BatteryPack.h" 1
# 19 "P3_MCP_Application/cmake-src/src/BatteryPack.h"
typedef enum
{
  batSET_CONTROL_MODE = 0x00,
  batSET_CONTROL_TEMPERATURE = 0x55,
  batSET_BATTERY_USAGE = 0xAA,
  batSET_NUMBER_ACTIVATIONS = 0xBB,
  batSET_CAPACITY = 0xCC
...
typedef union
{
  ...
  struct
  {
    unsigned short BatteryConfig_Fail : 1;
    unsigned short Spare0 : 1;
    unsigned short Spare1 : 1;
    unsigned short Spare2 : 1;
    unsigned short Spare3 : 1;
    unsigned short Spare4 : 1;
    unsigned short Spare5 : 1;
    unsigned short Spare6 : 1;
    unsigned short Spare7 : 1;
    unsigned short Spare8 : 1;
    unsigned short Spare9 : 1;
    unsigned short Spare10 : 1;
    unsigned short Spare11 : 1;
    unsigned short Spare12 : 1;
    unsigned short Spare13 : 1;
    unsigned short Spare15 : 1;
  } Bits;
} sBatteryPackSBIT;
...
# 43 "P3_MCP_Application/cmake-src/src/BatteryPack.c" 2
# 57 "P3_MCP_Application/cmake-src/src/BatteryPack.c"
typedef enum
{
  bsGET_SYNC_1,
  bsGET_SYNC_2,
...
void BatteryPackInit(char *AuxStr)
{
  ...
  BatteryPack.BatteryWaitForRxMsg = 0;
  BatteryPack.isBatteryConfigChecked = 0;
 ...
 sprintf(AuxStr,"%s%u:BATTERY PACK Parameters Initialized\n",AuxStr,GetTimeUs());
  ...
  BatteryPackSendLogFlag = 0;
  BatteryPackRequestLogFlag = 0;
  Battery10msCnt = 0;
  BateryPackRxIndex = 0;
  BateryPackState = bsGET_SYNC_1;

  BatteryPackCommandMsg.Header.Sync1 = 0xEB;
  BatteryPackCommandMsg.Header.Sync2 = 0x90 | 0x00;
  ...
  BatteryPackLogDataMsg.Header.Sync1 = 0xEB;
  BatteryPackLogDataMsg.Header.Sync2 = 0x90 | 0x01;
  BatteryPackLogDataMsg.Reserved = 0;

  BatteryPackRequestLogMsg.Sync1 = 0xEB;
  BatteryPackRequestLogMsg.Sync2 = 0x90 | 0x02;

  BatteryPackSetCommand(batSET_CONTROL_MODE, btcAUTO);

  UART_Init(&BatteryPackUART, 0x43400000, br115200, parNONE, 1, 0);
}
...
void BatteryPackSetLog(sBatteryPackLog *Log)
{
  ...
  BatteryPackSendLogFlag = 1;
}

void BatteryPackRequestLog(void)
{
  BatteryPackRequestLogFlag = 1;
}
...
void BatteryPackSendMsg(void)
{
  ...
  if ((Battery10msCnt % 5) == 0) {
    ...
    BatteryPack.BatteryWaitForRxMsg = 1;
    BatteryPack.TxCnt++;
  }
}
...
void BatteryPackLogReportSendAux(void){
 ...
 for (int i = 0; i < (unsigned char)(5); i++) {
 ...
 for (int i = 0; i < (unsigned char)(3); i++) {
 ...
 for (int i = 0; i < (unsigned char)(8); i++) {
            ...
            if (BatteryPackRxMsg.Header.Checksum == CalculateXOR_Checksum(BatteryPackRxMsg.Data, BateryPackRxMsgLenth)) {
              ...
              if (BatteryRxMsgId == 0x00) {
                ...
                if(!BatteryPack.isBatteryConfigChecked)
                {
                 ...
                 BatteryPack.isBatteryConfigChecked = 1;
                }
